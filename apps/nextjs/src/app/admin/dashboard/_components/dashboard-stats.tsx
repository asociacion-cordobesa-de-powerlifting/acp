...
import { Users, Trophy, ClipboardList, UserCheck, UserX, Clock, CheckCircle2, XCircle } from "lucide-react"
...
export function DashboardStats() {
    const trpc = useTRPC()
    const { data: stats } = useSuspenseQuery(trpc.tournaments.stats.queryOptions())
    ...
    const statCards = [
        ...
        },
        {
            ...
            icon: Trophy,
            link: "/admin/dashboard/tournaments",
